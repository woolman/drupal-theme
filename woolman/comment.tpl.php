 ...
 * Woolman theme implementation for comments.
 *
 * Available variables:
...
<div class="<?php print $classes; ?>"><div class="comment-inner clear-block">
  ...
  <div class="name-date">
    On <span class="date"><?php print strftime("%b %e, %Y",$comment->timestamp); ?></span>, <span class="name"><?php print $author;?></span>  said:
  </div>
